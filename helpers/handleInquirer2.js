...
//function myFunction() {
 //   myscore = Math.round(score+choices)
//}
...
var choices = {
    'Cross at the first point I come to' : -5,
    'Walk down the river to see if it moves slower at another point' : -2.5,
    'Climb to a high point to look at the the depth of the water' : -0
}
function myFunction() {
    myscore = score - choices
}
...
var choices = {
    'Yell at them' : -5,
    'Make fun of them' : -2.5,
    'Lie to them that everything is going to be alright' : -0
}
function myFunction() {
    myscore = score - choices
}
...
//point order -0, -5, -2.5
var choices = {
    'Boil the water before drinking it' : -0,
    'Filter the water through a sock' : -5,
    'Have someone else drink it first to see if they get sick' : -2.5
